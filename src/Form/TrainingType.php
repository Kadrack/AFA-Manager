...
class TrainingType extends AbstractType
{
     ...
     * @param FormBuilderInterface $builder
     */
    private function discount(FormBuilderInterface $builder): void
    {
        $builder
            ->add('TrainingAttendancePaymentDiscount', MoneyType::class, array('label' => 'Ristourne', 'required' => true, 'divisor' => 100))
    ...
    private function attendance(FormBuilderInterface $builder, array $data): void
    {
        ...
        $builder->add('TrainingAttendanceStatus', ChoiceType::class, array('label' => 'Session : ', 'multiple' => false, 'expanded' => false, 'choices' => array('Inscription' => 1, 'Pre-Paiement' => 2), 'disabled' => !$data['Status']));
        ...
        {
            $builder
                ->add('TrainingAttendanceSessions', ChoiceType::class, array('label' => 'Session : ', 'multiple' => true, 'expanded' => true, 'choices' => $data['Choices'], 'mapped' => false, 'choice_value' => 'trainingSessionId', 'choice_label' => 'training_session_choice_name'))
                ->get('TrainingAttendanceSessions')->setData($data['OldSessions']);
        }
    ...
    private function session(FormBuilderInterface $builder, array $data): void
    {
        ...
        $builder
            ...
            ->add('TrainingSessionStart', TimeType::class, array ('label' => 'Début', 'widget' => 'single_text', 'attr' => array('placeholder' => 'TrainingSessionStart'), 'row_attr' => array('class' => 'form-floating')))
            ->add('TrainingSessionEnd', TimeType::class, array ('label' => 'Fin', 'widget' => 'single_text', 'attr' => array('placeholder' => 'TrainingSessionEnd'), 'row_attr' => array('class' => 'form-floating')));
